...
function validateRunCompliance(runValidation, run, errors, warnings) {
  ...
  if (runValidation.resources?.orchestrationRegistry?.schema_version !== "5.0.0") {
    addError(errors, "run must use orchestration registry version 5.0.0");
  }
