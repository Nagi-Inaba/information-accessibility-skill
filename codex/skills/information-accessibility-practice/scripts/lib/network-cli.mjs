...
export function prepareNetworkCapture(options, outputs = []) {
  ...
  if (!validation.valid || run.schema_version !== "13.0.0" || run.permissions.network !== "allowlisted") throw new Error("Browser capture requires a validated current run with concrete network permission.");
