...
test("requirements search supports Japanese and English terms plus profile, level, and procedure filters", () => {
  ...
  assert.deepEqual(
    ...
    ["1.1.1", "1.3.1", "1.4.1", "1.4.3", "1.4.4", "1.4.10", "1.4.11", "2.1.1", "2.1.2", "2.4.1", "2.4.3", "2.4.7", "2.4.11", "2.5.1", "2.5.7", "2.5.8", "3.1.1", "3.3.1", "3.3.2", "3.3.3", "3.3.4", "3.3.7", "3.3.8", "4.1.2", "4.1.3"]
  );
});
