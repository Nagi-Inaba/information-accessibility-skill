...
const EXACT_RUN_VERSION = "14.0.0";
...
function validateRunCompliance(runValidation, run, errors, warnings) {
  ...
  if (runValidation.resources?.orchestrationRegistry?.schema_version !== "13.0.0") {
    addError(errors, "run must use orchestration registry version 13.0.0");
  }
