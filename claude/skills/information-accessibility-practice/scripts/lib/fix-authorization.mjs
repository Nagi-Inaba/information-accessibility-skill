...
const EXACT_RUN_VERSION = "11.0.0";
...
function validateRunCompliance(runValidation, run, errors, warnings) {
  ...
  if (runValidation.resources?.orchestrationRegistry?.schema_version !== "10.0.0") {
    addError(errors, "run must use orchestration registry version 10.0.0");
  }
