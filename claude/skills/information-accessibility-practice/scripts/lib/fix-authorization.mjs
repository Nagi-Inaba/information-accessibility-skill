...
const EXACT_RUN_VERSION = "10.0.0";
...
function validateRunCompliance(runValidation, run, errors, warnings) {
  ...
  if (runValidation.resources?.orchestrationRegistry?.schema_version !== "9.0.0") {
    addError(errors, "run must use orchestration registry version 9.0.0");
  }
