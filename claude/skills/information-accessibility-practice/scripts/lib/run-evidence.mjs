...
export function createRunEvidenceReference({ run, targetRef, ...options }) {
  ...
  const measuredRun = ["8.0.0", "9.0.0", "10.0.0", "11.0.0", "12.0.0", "13.0.0"].includes(run.schema_version);
...
export function evidenceBindingErrors(reference, run) {
  ...
  try {
    ...
    if (["8.0.0", "9.0.0", "10.0.0", "11.0.0", "12.0.0", "13.0.0"].includes(run.schema_version)) {
